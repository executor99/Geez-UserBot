...
DEF_UNAPPROVED_MSG = (
    "╭┈──────────────────────\n"
    "│“𝙄𝙉𝙂𝙀𝙏 𝙆𝙊𝙉𝙏𝙊𝙇 𝙅𝘼𝙉𝙂𝘼𝙉 𝙉𝙂𝙀𝙎𝙋𝘼𝙈 𝘾𝙃𝘼𝙏❗”\n"
    "├┈────────────────────\n"
    "│𝗗𝗜𝗟𝗔𝗥𝗔𝗡𝗚 𝗠𝗘𝗟𝗔𝗞𝗨𝗞𝗔𝗡 𝗦𝗣𝗔𝗠𝗠𝗜𝗡𝗚 𝘾𝙃𝘼𝙏❗\n│\n"
    f"| 𝙅𝘼𝙉𝙂𝘼𝙉 𝙉𝙂𝙀𝙔𝙀𝙇 𝙆𝙊𝙉𝙏𝙊𝙇\|𝙆𝙊𝙉𝙏𝙊𝙇, 𝙏𝙪𝙣𝙜𝙜𝙪 𝘼𝙞𝙣𝙜 𝙎𝙖𝙢𝙥𝙖𝙞 {DEFAULTUSER}\n|𝙈𝙚𝙣𝙚𝙧𝙞𝙢𝙖 𝙋𝙚𝙨𝙖𝙣 𝙇𝙪 𝙆𝙤𝙣𝙩𝙤𝙡, 𝙈𝙖𝙠𝙖𝙨𝙞𝙝.\n"
    "├┈──────────────────────\n"
    "│ ○› `AUTOMATIC MESSAGES`\n"
    f"│ ○› `BY` 𝙀𝙓𝙀𝘾𝙐𝙏𝙊𝙍\n"
    "╰┈────────────────")
