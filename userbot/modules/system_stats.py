...
async def amireallyalive(alive):
    ...
    await get_readable_time((time.time() - StartTime))
    output = (
        f"**ㅤㅤㅤㅤ ☄️ 𝙈𝙀𝙈𝙀𝙒 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 ☄️**\n"
        f"╔══════════╬════╬══════════╗ \n"
        f"╟⟩⟩ 🤴 • `ᴏᴡɴᴇʀ    :`[𝙊𝙒𝙉𝙀𝙍 𝘽𝙊𝙆𝙀𝙋](t.me/penjelajahdimensi)             ㅤ ║\n"
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f"🔰 : [𝙂𝙍𝙊𝙐𝙋 𝘽𝙊𝙆𝙀𝙋](https://t.me/VideoViralxxx)\n👥 : [𝙍𝙀𝙑𝙊𝙇𝙐𝙏𝙄𝙊𝙉 𝙎𝙐𝙋𝙋𝙊𝙍𝙏](t.me/thisrevolution)\n👤 : [𝗢𝗪𝗡𝗘𝗥](t.me/penjelajahdimensii)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://t.me/penjelajahdimensii)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/thisrevolution)  |  "
        f"[𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝘽𝙊𝙆𝙀𝙋](https://t.me/VideoViralxxx)\n"
        f"╰═──────╼═⌘═╾───────═")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
